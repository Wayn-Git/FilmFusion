...
const TVShowCard = ({ show }) => {
  return (
    <Link to={`/tv-show/${show.id}`} className="group">
      <div className="bg-gray-800 rounded-lg overflow-hidden shadow-lg transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
        ...
        <div className="p-4">
          <h3 className="text-white font-medium line-clamp-1">{show.name}</h3>
          ...
          <p className="text-gray-400 text-sm mt-2 line-clamp-2">{show.first_air_date?.split('-')[0]}</p>
        </div>
      </div>
    </Link>
  );
    ...
    <div className="min-h-screen bg-gray-900">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex items-center justify-between mb-8">
          <h1 className="text-3xl sm:text-4xl font-bold text-white">Popular TV Shows</h1>
        </div>
