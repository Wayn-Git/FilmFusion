    ...
    >
      <Link to={`/movie/${movie.id}`}>
        ...
        <div className="p-5">
          ...
          <p className="text-purple-200/70 text-sm mt-1">{new Date(movie.release_date).getFullYear()}</p>
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-16">
        ...
        >
          ...
          <p className="text-purple-200/80 max-w-2xl mx-auto">
            Discover the most popular movies that are trending right now. Updated daily based on user engagement.
          </p>
        </motion.div>

        {loading ? <LoadingSkeleton /> : <MovieList movies={movies} />}
